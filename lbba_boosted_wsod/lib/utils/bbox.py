...
def bbox_overlaps(boxes, query_boxes):
    ...
    # print(boxes.dtype,query_boxes.dtype)
    # boxes = boxes.to(torch.float32)
    # query_boxes = query_boxes.to(torch.float32)
    # box_areas = box_areas.to(torch.float32)
    # query_areas = query_areas.to(torch.float32)
