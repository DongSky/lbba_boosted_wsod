...
from layer_utils.anchor_target_layer_fast import anchor_target_layer_fast
from layer_utils.proposal_target_layer_fast import proposal_target_layer_fast
...
class Network_Fast(nn.Module):
    ...
    def _anchor_target_layer(self, rpn_cls_score):
        ...
        # print(self._gt_boxes.dtype)
        self._gt_boxes = self._gt_boxes.to(torch.float32)
        rpn_labels, rpn_bbox_targets, rpn_bbox_inside_weights, rpn_bbox_outside_weights = \
            anchor_target_layer_fast(
